...
{
    public abstract class CricketApplicationWebPortalWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CricketApplicationWebPortalWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CricketApplicationWebPortalWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CricketApplicationWebPortalDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CricketApplicationWebPortalDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CricketApplicationWebPortalDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CricketApplicationWebPortalDbContext, Task<T>> func)
        {
            T result;
