...
export class TeamServiceProxy {
     ...
     * @return Success
     */
    createOrEdit(body: CreateTeamDto | undefined): Observable<ResponseMessagesDto> {
        let url_ = this.baseUrl + "/api/services/app/Team/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getById(id: number | undefined): Observable<TeamDto> {
        let url_ = this.baseUrl + "/api/services/app/Team/GetById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGetById(response: HttpResponseBase): Observable<TeamDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: number | undefined): Observable<ResponseMessagesDto> {
        let url_ = this.baseUrl + "/api/services/app/Team/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    getAll(tenantId: number | null | undefined): Observable<TeamDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Team/GetAll?";
     ...
     * @return Success
     */
    getPaginatedAll(keyword: string | null | undefined, tenantId: number | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<TeamDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Team/GetPaginatedAll?";
        if (keyword !== undefined && keyword !== null)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        if (tenantId !== undefined && tenantId !== null)
            url_ += "TenantId=" + encodeURIComponent("" + tenantId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TeamDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TeamDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetPaginatedAll(response: HttpResponseBase): Observable<TeamDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TeamDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TeamDtoPagedResultDto>(<any>null);
    }
}
...
export class TeamDtoPagedResultDto implements ITeamDtoPagedResultDto {
    totalCount: number;
    items: TeamDto[] | undefined;

    constructor(data?: ITeamDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(TeamDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): TeamDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new TeamDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface ITeamDtoPagedResultDto {
    totalCount: number;
    items: TeamDto[] | undefined;
}
